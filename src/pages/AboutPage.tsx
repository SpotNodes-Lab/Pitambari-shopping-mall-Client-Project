  ...
  return (
    <>
      ...
      <AboutStorySection
        ...
        paragraphs={[
          "Dholi Sati Retail Mall India Ltd. is more than just a place to shop; it is a well-established brand with a long history that dates back over eighty years.",
